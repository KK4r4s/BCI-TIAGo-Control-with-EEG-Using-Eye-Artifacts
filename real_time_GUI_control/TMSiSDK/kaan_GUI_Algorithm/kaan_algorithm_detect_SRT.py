...
class Classification_Algorithm_SRT:
    ...
    """
    def __init__(self, device, _save_events,queueS2_S3, queueS3_S2):
    ...
    def stop(self):
        ...
        self.queueS3_S2.put(["Finished",[float("nan"),float("nan")],[float("nan"),float("nan")]])
...
class FilterThread(threading.Thread):
    ...
    def __init__(self, main_class):
        ...
        # Queue for communicating with other Processes
        self.queueS3_S2 = main_class.queueS3_S2
        self.queueS2_S3= main_class.queueS2_S3
    ...
    def EM_B_Detection_Algorithm(self,stream,time_stream):
        ...
        Blink_max_peaks, Blink_max_values = signal.find_peaks(stream[1,:], height=100) # Not necessary, redundancy
        Blink_min_peaks, Blink_min_values = signal.find_peaks(-1*stream[1,:], height=0)  # Not necessary,  redundancy 
            ...
            while not self.q_sample_sets.empty():
                ...
                if not self.queueS2_S3.empty():
                    ...
                    if Condition_Close=="Close":
                        print("Blink Detection GUI is terminated.\nPlease Close the Semi Real Time Plot ")
                        self.sampling=False
                        break
